	...
	<div class="wp-block-columns alignwide has-small-font-size" style="margin-top:var(--wp--preset--spacing--30)">
		...
		<div class="wp-block-column">
			...
			<div class="wp-block-group">
				<!-- wp:paragraph -->
				<p>
					<?php echo esc_html_x( 'Posted', 'Verb to explain the publication status of a post', 'hello-blocks' ); ?>
				</p>
				<!-- /wp:paragraph -->
				...
				<!-- wp:paragraph -->
				<p>
					<?php echo esc_html_x( 'in', 'Preposition to show the relationship between the post and its categories', 'hello-blocks' ); ?>
				</p>
				<!-- /wp:paragraph -->
			...
			<div class="wp-block-group">
				<!-- wp:paragraph -->
				<p>
					<?php echo esc_html_x( 'by', 'Preposition to show the relationship between the post and its author', 'hello-blocks' ); ?>
				</p>
				<!-- /wp:paragraph -->
		...
		<div class="wp-block-column">
			...
			<div class="wp-block-group">
				<!-- wp:paragraph -->
				<p>
					<?php echo esc_html_x( 'Tags:', 'Label for a list of post tags', 'hello-blocks' ); ?>
				</p>
				<!-- /wp:paragraph -->
